...
- [**⚡ بهینه‌سازی Forced Reflow v3.1**](FORCED-REFLOW-V3.md) 🔥 جدیدترین
...
- [**🔧 رفع مشکل ذخیره تنظیمات PageSpeed Admin**](PAGESPEED-ADMIN-FIX.md) 🆕
...
- [**🔗 SEO Redirects**](SEO-REDIRECTS.md) 🔥 بروز شده v1.1.0
  - مدیریت 301 Redirects
  - Rank Math Configuration
  - **فیکس Pagination 404** (جدید v5.6.8)
  - بلاک صفحات `/page/X` بدون محتوا
  - بلاک URLهای غلط مثل `/page2`
...
تمامی تغییرات، بهبودها و اصلاحات در فایل‌های Changelog ثبت شده است:

- [**📝 Changelog فارسی**](changelog/CHANGELOG-FA.md)
  - تاریخچه کامل تغییرات به فارسی
  - بروزرسانی‌های نسخه‌های مختلف
  - توضیحات تفصیلی هر تغییر

- [**📝 Changelog English**](changelog/CHANGELOG-EN.md)
